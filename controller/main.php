	...
	public function handle($mode)
	{
		...
		while ($row = $this->db->sql_fetchrow($result))
		{
			...
			if (isset($json[$json_tree][$style_varname]))
			{
				...
				$style_info .= '<br><strong>' . $this->language->lang('DESIGNER') . $this->language->lang('COLON') . '</strong> ' . $this->display_author_info(isset($json[$json_tree][$style_varname]['author']) ? $json[$json_tree][$style_varname]['author'] : '', isset($json[$json_tree][$style_varname]['author_url']) ? $json[$json_tree][$style_varname]['author_url'] : '');
