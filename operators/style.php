...
class style implements style_interface
{
	...
	*/
	public function get_styles($only_active = true)
	{
		...
		{
			$entities[] = $this->container->get('vinabb.stylesdemo.entities.style')->import($row);
		}
		$this->db->sql_freeresult($result);
	...
	* Add a style
	*
	* @param \vinabb\stylesdemo\entities\style_interface $entity Style entity
	* @return \vinabb\stylesdemo\entities\style_interface
	*/
	public function add_style(\vinabb\stylesdemo\entities\style_interface $entity)
	{
