...
class release_1_0_0 extends migration
{
	public function update_data()
	{
		return array(
			...
			array('permission.permission_set', array(constants::ROLE_ADMIN_DEMO, 'a_extensions', 'role', false)),
			...
			array('permission.permission_set', array(constants::ROLE_ADMIN_DEMO, 'a_modules', 'role', false)),
