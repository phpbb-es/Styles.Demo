...
class main
{
	...
	public function handle($mode)
	{
		...
		while ($row = $this->db->sql_fetchrow($result))
		{
			...
			if (isset($json[$json_tree][$style_varname]))
			{
				...
				$style_info .= '<br><strong>' . $this->user->lang('DESIGNER') . $this->user->lang('COLON') . '</strong> ' . $this->display_author_info(isset($json[$json_tree][$style_varname]['style_author']) ? $json[$json_tree][$style_varname]['style_author'] : '', isset($json[$json_tree][$style_varname]['style_author_url']) ? $json[$json_tree][$style_varname]['style_author_url'] : '');
			...
			else
			{
				...
				$style_info .= '<br><strong>' . $this->user->lang('DESIGNER') . $this->user->lang('COLON') . '</strong> ' . $this->display_author_info($row['style_author'], $row['style_author_url']);
	...
	*/
	protected function display_author_info($name, $url)
	{
		...
		{
			$info = '<a href="' . $url . '">' . $this->user->lang('UNKNOWN') . '</a>';
		}
