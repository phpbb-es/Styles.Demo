...
class release_1_0_0 extends migration
{
	...
	public function update_data()
	{
		return array(
			...
			//array('permission.permission_set', array('ROLE_ADMIN_DEMO', 'a_extensions')),
			...
			//array('permission.permission_set', array('ROLE_ADMIN_DEMO', 'a_modules')),
			array('permission.permission_set', array('ROLE_ADMIN_DEMO', 'a_names')),
			//array('permission.permission_set', array('ROLE_ADMIN_DEMO', 'a_phpinfo')),
			...
			array('permission.permission_set', array('ROLE_ADMIN_DEMO', 'a_switchperm')),
