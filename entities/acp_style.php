...
class acp_style extends style_data implements acp_style_interface
{
	...
	*/
	public function __construct(\phpbb\db\driver\driver_interface $db, \phpbb\extension\manager $ext_manager, $table_name)
	{
		$this->db = $db;
		...
		$this->style_path = "{$this->ext_root_path}app/styles/";
	}
